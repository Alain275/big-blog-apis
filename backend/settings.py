...
SECRET_KEY = 'django-insecure-264e881p6p42)3nx15c@n06uhb5_jih66@f3)31hwa)q_#_0ka'
...
MEDIA_URL = '/'
MEDIA_ROOT = os.path.join(BASE_DIR, '')  # Correctly set up media root
...
JAZZMIN_SETTINGS = {
    "site_title": "SHEMA Alain",
    "site_header": "SHEMA Alain",
    "site_brand": "Modern Marketplace ",
    # "site_icon": "images/favicon.ico",
    # "site_logo": "images/logos/logo.jpg",
    "welcome_sign": "Welcome To SHEMA Alain",
    "copyright": "SHEMA Alain",
